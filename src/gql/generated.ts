...
>(
  variables?: GetOrganizationsQueryVariables,
  options?: Omit<
    UseSuspenseQueryOptions<GetOrganizationsQuery, TError, TData>,
    "queryKey"
  > & {
  ...
  return useSuspenseQuery<GetOrganizationsQuery, TError, TData>({
    queryKey:
      variables === undefined
        ? ["GetOrganizationsSuspense"]
        : ["GetOrganizationsSuspense", variables],
    queryFn: fetcher<GetOrganizationsQuery, GetOrganizationsQueryVariables>(
      GetOrganizationsDocument,
      variables
    ),
...
useSuspenseGetOrganizationsQuery.getKey = (
  variables?: GetOrganizationsQueryVariables
) =>
  variables === undefined
    ? ["GetOrganizationsSuspense"]
